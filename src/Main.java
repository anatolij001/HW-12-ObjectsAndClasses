public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Автор 1 - "+stephenKing.getAuthorFirstName()+" "+stephenKing.getAuthorLastName());
        System.out.println("Год издания книги 1 - "+it.getBookYear()+"\n");

        //---    Книга 2   ---
        System.out.println("Книга 2 - " + tomSawyerAbroad.getBookName());
        System.out.println("Автор 2 - "+markTwain.getAuthorFirstName()+" "+markTwain.getAuthorLastName());
